...
class Image
{
    ...
    public function validate()
    {
        ...
        {
            if (is_debug())
                throw new \Exception('Image file not found: The image file \'' . $this->sFile . '\' could not be found.');
            else
                return false;
        }
        else
     ...
     * @desc Square.
     * @param integer $iSize
     * @see \H2O\Image::dynamicResize() The method that is returned by this method.
     * @return object $this
     */
     ...
     * @see \H2O\Image::crop() The method that is returned by this method.
     * @return object $this
     * @throws \Exception If the image crop is invalid.
     */
    public function zoneCrop($iWidth, $iHeight, $sZone = 'center')
    {
        ...
        switch ($sZone)
        {
            ...
            // Invalid Zone
            default:
                throw new \Exception('Invalid image crop zone ' . $sZone . ' given for image helper zoneCrop().');
        }
     ...
     * @param string $sFile
     * @return object $this
     * @throws \Exception If the image format is invalid.
     */
    public function save($sFile)
    {
        switch ($this->sType)
        {
            ...
            // Invalid Zone
            default:
                throw new \Exception('Invalid format Image in method ' . __METHOD__ . ' of class ' . __CLASS__);
        }
