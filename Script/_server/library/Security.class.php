...
if (version_compare(PHP_VERSION, '5.5.0', '<'))
    require H2O_SERVER_PATH . 'inc/crypt.inc.php';
...
final class Security
{
    ...
    PREFIX_SALT = 'c好，你今Здраврыве ты PPDç!é@ў паітаньне е54ljdйте天rt&eh好嗎_dمرحبا أنت بخير ال好嗎attú^u5atá inniu4a,?478привіなたは大丈夫今日はтивпряьоהעלאai54ng_scси днесpt',
    SUFFIX_SALT = '*éà12_you_è§§=≃ù%µµ££$);&,?µpPJJ87°0à6t{èàùf*sxdslut_waruआप नमस्क你好，你今ार ठΓει好嗎α σαςb안녕하세oi요 괜찮은 o नमस्कार ठीnjre;,?*-<καλά σήμεραीक आजсегодняm_54tjהעלאdgezsядкمرحبا';
    ...
    public function userHash($sVal, $iLength, $sAlgo = 'whirlpool')
    {
        ...
        $sSalt = self::PREFIX_SALT . client_ip() . self::SUFFIX_SALT . user_agent();
